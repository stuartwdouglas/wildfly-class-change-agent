 ...
 */
public abstract class FakereplaceWebsocketProtocol extends Endpoint implements MessageHandler.Whole<byte[]> {
    ...
    protected abstract Map<String, byte[]> changedClasses();
    ...
    private void sendChangedClasses() {
        final Map<String, byte[]> changedClasses = changedClasses();
